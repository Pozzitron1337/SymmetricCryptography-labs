...
public class Entrophy {
    ...
    private Map<Character,Integer> sortedSymbolsFrequency;
    private int[][] bigramWithIntersectionFrequency;
    private int[][] bigramWithoutIntersectionFrequency;

    public Map<Character, Integer> getSortedSymbolsFrequency() {
    ...
    public void calculateSymbolsFrequency(){
        ...
        for (Character c:alphabet){
            unsortMap.put(c,symbolFrequency[map.get(c)]);
        }
    ...
    public void printToFileSortedSymbolFrequency(){
        ...
        {
           for (Character c:sortedSymbolsFrequency.keySet()) {
